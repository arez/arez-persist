...
public final class StoreTypes
{
   ...
   * when {@link ArezPersist#registerSessionScopedPersistStore(String)} has been invoked.
   */
  @Nonnull
   ...
   * This persist strategy is only available when {@link ArezPersist#registerLocalScopedPersistStore(String)}
   * has been invoked.
   */
  @Nonnull
