...
public final class ApiDiffTest
{
  ...
  public void compareApi()
    throws Exception
  {
    final boolean storeApiDiff = SystemProperty.get( "arez_persist.api_test.store_api_diff" ).equals( "true" );
  ...
  {
    final String oldApiLabel = "org.realityforge.arez:arez-core:jar:" + SystemProperty.get( "arez_persist.prev.version" );
    final String oldApi = oldApiLabel + "::" + SystemProperty.get( "arez_persist.prev.jar" );
    final String newApiLabel = "org.realityforge.arez:arez-core:jar:" + SystemProperty.get( "arez_persist.next.version" );
    final String newApi = newApiLabel + "::" + SystemProperty.get( "arez_persist.next.jar" );
    Exec.system( "java",
                 "-jar",
                 SystemProperty.get( "arez_persist.revapi.jar" ),
                 "--old-api",
                 oldApi,
                 "--new-api",
                 newApi,
  ...
  {
    return new File( SystemProperty.get( "arez_persist.api_test.fixture_dir" ),
                     SystemProperty.get( "arez_persist.prev.version" ) + "-" +
                     SystemProperty.get( "arez_persist.next.version" ) + ".json" );
  }
}
